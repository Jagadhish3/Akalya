...
const translationsMap: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Units
    'units.title': 'Course Lectures',
    'units.description': 'Watch video lectures and track your completion progress.',
    'units.unit': 'Unit',
    'units.noVideo': 'No video uploaded yet',
    'units.pending': 'Pending Upload',
    'units.watch': 'Watch',
    'units.completed': 'Completed',
    'units.uploaded': 'Uploaded',
    ...
    'nav.testSeries': 'Test Series',
    'nav.locker': 'My Locker',
    'nav.about': 'About',
    'nav.login': 'Login',
    ...
    // Practice
    'practice.title': 'Practice (Class 6–12)',
    'practice.description': 'MCQ-based practice with timer and auto evaluation. Earn badges based on your score!',
    'practice.selectTopic': 'Select Practice Topic',
    'practice.classLevel': 'Class Level',
    'practice.subject': 'Subject',
    'practice.start': 'Start Practice',
    'practice.submitting': 'Submit Answers',
    'practice.completed': 'Practice Completed!',
    'practice.yourScore': 'Your Score',
    'practice.timeTaken': 'Time Taken',
    'practice.achievement': 'Achievement Unlocked',
    'practice.tryAnother': 'Try another test',
    'practice.history': 'Your Practice History',
    'practice.score': 'Score',
    'practice.time': 'Time',
    'practice.class': 'Class',
    'practice.math': 'Mathematics',
    'practice.science': 'Science',
    'practice.social': 'Social Studies',
    'practice.english': 'English',
    'practice.physics': 'Physics',
    'practice.chemistry': 'Chemistry',
    'practice.biology': 'Biology',
    ...
    'ui.cancel': 'Cancel',
    'ui.close': 'Close',
    'ui.selectVideo': 'Select a video to play',
    'ui.courseVideo': 'Course Video',
    'ui.courseVideos': 'Course Videos',
    'ui.fromLastMonth': 'from last month',
    'ui.dueThisWeek': 'Due this week',
    'ui.enrolledCourses': 'Enrolled courses',
  ...
  hi: {
    ...
    'nav.practice': 'अभ्यास',
    'nav.testSeries': 'टेस्ट सीरीज',
    'nav.locker': 'मेरा लॉकर',
    ...
    // Units
    'units.title': 'पाठ्यक्रम व्याख्यान',
    'units.description': 'वीडियो व्याख्यान देखें और अपनी पूर्णता प्रगति को ट्रैक करें।',
    'units.unit': 'इकाई',
    'units.noVideo': 'अभी तक कोई वीडियो अपलोड नहीं किया गया है',
    'units.pending': 'अपलोड लंबित',
    'units.watch': 'देखें',
    'units.completed': 'पूरा हुआ',
    'units.uploaded': 'अपलोड किया गया',

    // UI
    'ui.close': 'बंद करें',
    'ui.selectVideo': 'चलाने के लिए एक वीडियो चुनें',
    'ui.courseVideo': 'पाठ्यक्रम वीडियो',
    'ui.courseVideos': 'पाठ्यक्रम वीडियो',
    'ui.fromLastMonth': 'पिछले महीने से',
    'ui.dueThisWeek': 'इस सप्ताह नियत',
    'ui.enrolledCourses': 'नामांकित पाठ्यक्रम',
    'ui.welcomeBack': 'वापसी पर स्वागत है',
    
    // Practice
    'practice.title': 'अभ्यास (कक्षा 6–12)',
    'practice.description': 'टाइमर और ऑटो मूल्यांकन के साथ MCQ-आधारित अभ्यास। अपने स्कोर के आधार पर बैज अर्जित करें!',
    'practice.selectTopic': 'अभ्यास विषय चुनें',
    'practice.classLevel': 'कक्षा का स्तर',
    'practice.subject': 'विषय',
    'practice.start': 'अभ्यास शुरू करें',
    'practice.submitting': 'उत्तर जमा करें',
    'practice.completed': 'अभ्यास पूरा हुआ!',
    'practice.yourScore': 'आपका स्कोर',
    'practice.timeTaken': 'लिया गया समय',
    'practice.achievement': 'उपलब्धि अनलॉक हुई',
    'practice.tryAnother': 'एक और परीक्षा का प्रयास करें',
    'practice.history': 'आपका अभ्यास इतिहास',
    'practice.score': 'स्कोर',
    'practice.time': 'समय',
    'practice.class': 'कक्षा',
    'practice.math': 'गणित',
    'practice.science': 'विज्ञान',
    'practice.social': 'सामाजिक अध्ययन',
    'practice.english': 'अंग्रेजी',
    'practice.physics': 'भौतिक विज्ञान',
    'practice.chemistry': 'रसायन विज्ञान',
    'practice.biology': 'जीव विज्ञान',
  },
  te: {
    // Common
    ...
    // Units
    'units.title': 'కోర్సు ఉపన్యాసాలు',
    'units.description': 'వీడియో ఉపన్యాసాలు చూడండి మరియు మీ పూర్తి పురోగతిని ట్రాక్ చేయండి.',
    'units.unit': 'యూనిట్',
    'units.noVideo': 'ఇంకా వీడియో అప్‌లోడ్ చేయబడలేదు',
    'units.pending': 'అప్‌లోడ్ పెండింగ్‌లో ఉంది',
    'units.watch': 'చూడండి',
    'units.completed': 'పూర్తయింది',
    'units.uploaded': 'అప్‌లోడ్ చేయబడింది',

    // UI
    'ui.close': 'మూసివేయి',
    'ui.selectVideo': 'ప్లే చేయడానికి వీడియోను ఎంచుకోండి',
    'ui.courseVideo': 'కోర్సు వీడియో',
    'ui.courseVideos': 'కోర్సు వీడియోలు',
    'ui.fromLastMonth': 'గత నెల నుండి',
    'ui.dueThisWeek': 'ఈ వారం గడువు',
    'ui.enrolledCourses': 'నమోదు చేసుకున్న కోర్సులు',
    'ui.welcomeBack': 'మళ్లీ స్వాగతం',
    
    // Practice
    'practice.title': 'అభ్యాసం (క్లాస్ 6–12)',
    'practice.description': 'టైమర్ మరియు ఆటో మూల్యాంకనంతో MCQ-ఆధారిత అభ్యాసం. మీ స్కోర్ ఆధారంగా బ్యాడ్జ్‌లను సంపాదించండి!',
    'practice.selectTopic': 'అభ్యాస అంశాన్ని ఎంచుకోండి',
    'practice.classLevel': 'తరగతి స్థాయి',
    'practice.subject': 'విషయం',
    'practice.start': 'అభ్యాసాన్ని ప్రారంభించండి',
    'practice.submitting': 'సమాధానాలను సమర్పించండి',
    'practice.completed': 'అభ్యాసం పూర్తయింది!',
    'practice.yourScore': 'మీ స్కోర్',
    'practice.timeTaken': 'తీసుకున్న సమయం',
    'practice.achievement': 'అచీవ్‌మెంట్ అన్‌లాక్ చేయబడింది',
    'practice.tryAnother': 'మరో పరీక్షను ప్రయత్నించండి',
    'practice.history': 'మీ అభ్యాస చరిత్ర',
    'practice.score': 'స్కోరు',
    'practice.time': 'సమయం',
    'practice.class': 'క్లాస్',
    'practice.math': 'గణితం',
    'practice.science': 'సైన్స్',
    'practice.social': 'సాంఘిక శాస్త్రం',
    'practice.english': 'ఇంగ్లీష్',
    'practice.physics': 'ఫిజిక్స్',
    'practice.chemistry': 'కెమిస్ట్రీ',
    'practice.biology': 'బయాలజీ',
  },
  pa: {
    // Common
    ...
    'nav.home': 'ਹੋਮ',
    'nav.scholarships': 'ਸਕਾਲਰਸ਼ਿਪ',
    'nav.entranceExams': 'ਪ੍ਰਵੇਸ਼ ਪ੍ਰੀਖਿਆਵਾਂ',
    'nav.jobs': 'ਨੌਕਰੀਆਂ',
    'nav.roadmap': 'ਕੈਰੀਅਰ ਰੋਡਮੈਪ',
    'nav.practice': 'ਅਭਿਆਸ',
    'nav.testSeries': 'ਟੈਸਟ ਸੀਰੀਜ਼',
    'nav.locker': 'ਮੇਰਾ ਲਾਕਰ',
    'nav.about': 'ਬਾਰੇ',
    'nav.login': 'ਲੌਗਇਨ',
    ...
    // Units
    'units.title': 'ਕੋਰਸ ਲੈਕਚਰ',
    'units.description': 'ਵੀਡੀਓ ਲੈਕਚਰ ਦੇਖੋ ਅਤੇ ਆਪਣੀ ਪੂਰਤੀ ਦੀ ਪ੍ਰਗਤੀ ਨੂੰ ਟ੍ਰੈਕ ਕਰੋ।',
    'units.unit': 'ਯੂਨਿਟ',
    'units.noVideo': 'ਅਜੇ ਤੱਕ ਕੋਈ ਵੀਡੀਓ ਅਪਲੋਡ ਨਹੀਂ ਕੀਤੀ ਗਈ',
    'units.pending': 'ਅਪਲੋਡ ਲੰਬਿਤ',
    'units.watch': 'ਦੇਖੋ',
    'units.completed': 'ਪੂਰਾ ਹੋਇਆ',
    'units.uploaded': 'ਅਪਲੋਡ ਕੀਤਾ ਗਿਆ',

    // UI
    'ui.close': 'ਬੰਦ ਕਰੋ',
    'ui.selectVideo': 'ਚਲਾਉਣ ਲਈ ਇੱਕ ਵੀਡੀਓ ਚੁਣੋ',
    'ui.courseVideo': 'ਕੋਰਸ ਵੀਡੀਓ',
    'ui.courseVideos': 'ਕੋਰਸ ਵੀਡੀਓ',
    'ui.fromLastMonth': 'ਪਿਛਲੇ ਮਹੀਨੇ ਤੋਂ',
    'ui.dueThisWeek': 'ਇਸ ਹਫ਼ਤੇ ਦੀ ਮਿਆਦ',
    'ui.enrolledCourses': 'ਦਾਖਲ ਕੀਤੇ ਕੋਰਸ',
    'ui.welcomeBack': 'ਵਾਪਸੀ ਤੇ ਜੀ ਆਇਆਂ ਨੂੰ',
    
    // Practice
    'practice.title': 'ਅਭਿਆਸ (ਕਲਾਸ 6–12)',
    'practice.description': 'ਟਾਈਮਰ ਅਤੇ ਆਟੋ ਮੁਲਾਂਕਣ ਦੇ ਨਾਲ MCQ-ਅਧਾਰਤ ਅਭਿਆਸ। ਆਪਣੇ ਸਕੋਰ ਦੇ ਅਧਾਰ ਤੇ ਬੈਜ ਕਮਾਓ!',
    'practice.selectTopic': 'ਅਭਿਆਸ ਵਿਸ਼ਾ ਚੁਣੋ',
    'practice.classLevel': 'ਕਲਾਸ ਪੱਧਰ',
    'practice.subject': 'ਵਿਸ਼ਾ',
    'practice.start': 'ਅਭਿਆਸ ਸ਼ੁਰੂ ਕਰੋ',
    'practice.submitting': 'ਜਵਾਬ ਜਮ੍ਹਾਂ ਕਰੋ',
    'practice.completed': 'ਅਭਿਆਸ ਪੂਰਾ ਹੋਇਆ!',
    'practice.yourScore': 'ਤੁਹਾਡਾ ਸਕੋਰ',
    'practice.timeTaken': 'ਲਿਆ ਗਿਆ ਸਮਾਂ',
    'practice.achievement': 'ਪ੍ਰਾਪਤੀ ਅਨਲੌਕ ਕੀਤੀ ਗਈ',
    'practice.tryAnother': 'ਇੱਕ ਹੋਰ ਟੈਸਟ ਦੀ ਕੋਸ਼ਿਸ਼ ਕਰੋ',
    'practice.history': 'ਤੁਹਾਡਾ ਅਭਿਆਸ ਇਤਿਹਾਸ',
    'practice.score': 'ਸਕੋਰ',
    'practice.time': 'ਸਮਾਂ',
    'practice.class': 'ਕਲਾਸ',
    'practice.math': 'ਗਣਿਤ',
    'practice.science': 'ਵਿਗਿਆਨ',
    'practice.social': 'ਸਮਾਜਿਕ ਅਧਿਐਨ',
    'practice.english': 'ਅੰਗਰੇਜ਼ੀ',
    'practice.physics': 'ਭੌਤਿਕ ਵਿਗਿਆਨ',
    'practice.chemistry': 'ਰਸਾਇਣ ਵਿਗਿਆਨ',
    'practice.biology': 'ਜੀਵ ਵਿਗਿਆਨ',
  },
};
